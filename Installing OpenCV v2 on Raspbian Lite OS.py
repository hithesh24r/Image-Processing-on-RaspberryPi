...
os.system("sudo su")
os.system("apt install cmake build-essential pkg-config git -y")
os.system("apt install libjpeg-dev libtiff-dev libjasper-dev libpng-dev libwebp-dev libopenexr-dev -y")
os.system("apt install libavcodec-dev libavformat-dev libswscale-dev libv4l-dev libxvidcore-dev libx264-dev libdc1394-22-dev libgstreamer-plugins-base1.0-dev libgstreamer1.0-dev -y")
os.system("apt install libgtk-3-dev libqt5gui5 libqt5webkit5 libqt5test5 python3-pyqt5 -y")
os.system("apt install libatlas-base-dev liblapacke-dev gfortran -y")
os.system("apt install libhdf5-dev libhdf5-103 -y")
os.system("apt install python3-dev python3-pip python3-numpy -y")
os.system("nano /etc/dphys-swapfile")
...
os.system("mkdir /home/pi/opencv/build")
os.system("cd /home/pi/opencv/build")
os.system("cmake -D CMAKE_BUILD_TYPE=RELEASE -D CMAKE_INSTALL_PREFIX=/usr/local -D OPENCV_EXTRA_MODULES_PATH=/home/pi/opencv_contrib/modules -D ENABLE_NEON=ON -D ENABLE_VFPV3=ON -D BUILD_TESTS=OFF -D INSTALL_PYTHON_EXAMPLES=OFF -D OPENCV_ENABLE_NONFREE=ON -D CMAKE_SHARED_LINKER_FLAGS=-latomic -D OPENCV_PYTHON_INSTALL_PATH=lib/python3.9/dist-packages -D BUILD_EXAMPLES=OFF ..")
