...
# Asking the user whether if he wants to upload the output file to clous (AWS S3 Bucket)
print("Do you want to send the output image to cloud storage")
cloud_decision = input("If yes, type 'y'; if no, type 'n': ")

if cloud_decision == 'y':
    image_destination = "/home/pi/bucket/"
elif cloud_decision == 'n':
    image_destination = "/home/pi/result/"

print(f"The output location is {image_destination}")
